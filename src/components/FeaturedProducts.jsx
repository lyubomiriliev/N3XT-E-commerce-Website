    ...
    return (
            <div className="w-full md:px-0 mx-auto flex flex-col items-center md:py-10">
                <div className="flex flex-col items-center gap-4">
                    <h1 className="text-3xl md:text-4xl py-10 font-bold text-center">NEW ARRIVALS</h1>
                </div>
                ...
                <Link to={`/${selectedSexCategory}/clothing`}>
                    <button className="w-40 h-10 border-[1px] rounded-3xl text-black border-gray-700 flex items-center justify-center font-bold uppercase hover:cursor-pointer hover:bg-gray-700 hover:text-white active:bg-gray-900 duration-300">Discover</button>
                </Link>
                </div>
            </div>
    )
