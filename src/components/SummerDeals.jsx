    ...
    <div className="w-full flex flex-col mx-auto items-center relative md:mt-10">
      ...
      >
        ...
        <div className="w-full flex flex-col justify-center mt-2 absolute top-2 left-4 md:left-10">
          ...
          <h3 className="text-white text-lg md:text-xl tracking-widest uppercase font-light">
            On selected products
          </h3>
          <button className="w-32 h-10 mt-2 mr-2 md:mt-4 border-[1px] rounded-md text-white md:text-white border-white md:border-white flex items-center justify-center hover:cursor-pointer hover:bg-white hover:text-black duration-300">
            SHOP NOW
          </button>
        </div>
