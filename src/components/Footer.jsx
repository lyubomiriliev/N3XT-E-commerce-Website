...
const Footer = () => {
    return (
        <div className="bg-black text-[#949494] py-10 px-5 md:py-20">
            <div className="max-w-screen-xl mx-auto grid grid-cols-2 flex-col md:grid-cols-4">
                <div className="flex flex-col gap-4">
                    ...
                    <img className="w-28" src={nextLogoWhite} alt="" />
                    <p className="text-xs">&copy; 2024 ALL RIGHTS RESERVED N3XT BRAND</p>
                </div>
                <div className="">
                    <h2 className="text-2xl mt-10 md:mt-0 font-semibold text-white mb-4">My account</h2>
                ...
                <div>
                    <h2 className="text-2xl font-semibold text-white mb-4 mt-2 md:mt-0">Locate Us</h2>
                    <div className="text-base flex flex-col gap-2">
                        <p>Sale points</p>
