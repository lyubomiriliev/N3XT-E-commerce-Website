    ...
    <div>
      <div className="w-full flex flex-col items-center mb-10">
        <div
          ...
          className="text-base w-full h-12 tracking-wide border-[1px] border-gray-400 rounded-md flex items-center justify-center gap-2 hover:border-blue-600 cursor-pointer duration-300"
        >
        ...
        <div
          ...
          className="text-base w-full h-12 tracking-wide border-[1px] mt-4 border-gray-400 rounded-md flex items-center justify-center gap-2 hover:border-blue-600 cursor-pointer duration-300"
        >
